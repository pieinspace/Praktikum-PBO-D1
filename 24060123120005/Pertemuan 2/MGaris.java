...
public class MGaris {
    public static void main(String[] args) {
        ...
        if (G2.getTitikAwal().getAbsis() == G2.getTitikAkhir().getAbsis()) {
        ...
        if (G3.getTitikAwal().getAbsis() == G3.getTitikAkhir().getAbsis()) {
        ...
        G1.getTitikTengah().printTitik(); // Pakai cara ini untuk print supaya gaperlu toString(), karena di Java kalo
                                          // kita return object outputnya alamat memorinya
